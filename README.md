...
[![Nuget](https://img.shields.io/nuget/v/SoftwareAteliers.MediControl.svg?style=flat&color=2196f3)](https://www.nuget.org/packages/SoftwareAteliers.MediControl/)
...
* Install the template from NuGet repository: `dotnet new -i SoftwareAteliers.MediControl`
